...
const ExperienceBox = styled.div`
  ...
  transition: box-shadow 0.3s ease-in-out;
    ...
    &:hover {
        -webkit-box-shadow: 0 1px 12px -2px rgba(255, 255, 255, 1);
        -moz-box-shadow: 0 1px 12px -2px rgba(255, 255, 255, 1);
        box-shadow: 0 1px 12px -2px rgba(255, 255, 255, 1);
    }
  ...
  return (
    <>
      ...
      <Container>
        ...
        <SkillSetContainer style={{ marginBottom: '40px' }}>
          <SkillBox>
            <Icon xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
